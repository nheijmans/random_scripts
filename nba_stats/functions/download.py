"""
Download script for Basketbal Reference
"""
...
def download(year=datetime.utcnow().year):
    url    = "https://www.basketball-reference.com/leagues/NBA_{}_per_game.html#per_game_stats::none".format(year)
    raw   = requests.get(url,timeout=5)
    ...
    with open("logs/nba_daily_stats.csv","w") as ofile:
